...
'''global SCRIPT_DIR, FONT, FACE_CASCADE, Data_list, Datafile [SCRIPT_DIR, FONT,FACE_CASCADE, Data_list, Datafile]=cam_face.constants()''' #global Data_list, Datafile [Data_list,Datafile]=cam_face.getData()  

 

#global face_r face_r=cam_face.initialize_recognizer()  
...
RPi.setmode(RPi.BCM)  #BCM tai BOARD eli RPi.setmode(RPi.BOARD) 

 

def main():
    pir = GPIO(5, GPIO.IN) # this too mode='b' played=False  
